...
function NavBar() {
    ...
    return (
        <div className={"bg-sec text-primary_text text-xl"}>
            <ul className={"max-w-screen-xl flex items-center justify-between mx-auto px-2 py-4"}>

                <li className={"w-1/2"}>
                    <Link to="/">Home</Link>
                </li>
                <div className={"flex items-center justify-evenly mx-auto p-4 w-1/2"}>
                    <li>
                    ...
                    <li className={"w-1/2"}>
                        {isLoggedIn ?
                            <li className={"justify-evenly flex"}> Logout </li>
